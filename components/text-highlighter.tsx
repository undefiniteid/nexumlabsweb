...
// Helper local para evitar fallos de importación de lib/utils
  ...
  (
    {
      ...
      className,
      highlightColor = 'linear-gradient(90deg, #3b82f6, #a855f7)', // Azul a Púrpura (Nexum style)
    ...
    const getTailwindClasses = () => {
      ...
      return `${highlightColor} ${rounded} px-1`;
    };
